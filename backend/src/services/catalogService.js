...
export const CatalogService = {
  ...
  async createTraiteurRequest({ nom, tel, typeEvenement, nbPersonnes, dateEvenement, message, userId }) {
    if (!nom || !tel) {
      const e = new Error("Nom et téléphone requis pour une demande traiteur.");
      e.status = 400;
      throw e;
    }
