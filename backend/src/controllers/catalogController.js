...
export const CatalogController = {
  ...
  async createTraiteurRequest({ req, res, body }) {
    let userId = null;
    try { userId = requireAuth(req).sub; } catch { /* demande possible sans compte */ }
    sendJson(res, 201, await CatalogService.createTraiteurRequest({ ...body, userId }));
  },
};
